...
namespace EffectViewer.Projects
{
    public sealed class AssetIndex
    {
        ...
        private readonly Dictionary<string, EffectAsset> _reanims = new(StringComparer.OrdinalIgnoreCase);
        ...
        public IReadOnlyDictionary<string, EffectAsset> Reanims => _reanims;
        ...
        public AssetIndex(ProjectManifest manifest)
        {
            ...
            AddEffects(manifest.Reanims, _reanims);
