...
namespace EffectViewer.EffectRuntime.Reanim.Attachment
{
    public static class GlobalMembersAttachment
    {
        ...
        public static void AttachmentOverrideColor(EffectSystem effectSystem, AttachmentID theAttachmentID, in EffectColor theColor)
        {
            if (theAttachmentID == AttachmentID.Null)
            {
                return;
        ...
        public static void AttachmentDraw(EffectSystem effectSystem, AttachmentID theAttachmentID, EffectViewer.EffectRuntime.Graphics.Graphics g, bool theParentHidden)
        {
            if (theAttachmentID == AttachmentID.Null)
            {
                return;
        ...
        public static ref AttachEffect AttachParticle(EffectSystem effectSystem, ref AttachmentID theAttachmentID, ParticleSystem theParticleSystem, float theOffsetX, float theOffsetY)
        {
        ...
        public static ref AttachEffect AttachTrail(EffectSystem effectSystem, ref AttachmentID theAttachmentID, EffectViewer.EffectRuntime.Trail.Trail theTrail, float theOffsetX, float theOffsetY)
        {
            effectSystem = RequireEffectSystem(effectSystem);
        ...
        public static void AttachmentDetachCrossFadeParticleType(EffectSystem effectSystem, AttachmentID theAttachmentID, string theParticleEffect, string theCrossFadeName)
        {
            ...
            for (int i = 0; i < aAttachment.mNumEffects; i++)
            {
                ...
                {
                    ParticleSystem aParticleSystem = effectSystem.mParticleHolder.mParticleSystems.DataArrayTryToGet((ParticleSystemID)aAttachEffect.mEffectID);
        ...
        public static void AttachmentPropogateColor(EffectSystem effectSystem, AttachmentID theAttachmentID, in EffectColor theColor, bool theEnableAdditiveColor, in EffectColor theAdditiveColor, bool theEnableOverlayColor, in EffectColor theOverlayColor)
        {
            if (theAttachmentID == AttachmentID.Null)
            {
                return;
        ...
        public static EffectViewer.EffectRuntime.Trail.Trail FindTrailAttachment(EffectSystem effectSystem, AttachmentID theAttachmentID)
        {
            if (theAttachmentID == AttachmentID.Null)
            {
                return null;
            ...
            for (int i = 0; i < aAttachment.mNumEffects; i++)
            {
                ...
                {
                    EffectViewer.EffectRuntime.Trail.Trail aTrail = effectSystem.mTrailHolder.mTrails.DataArrayTryToGet((TrailID)aAttachEffect.mEffectID);
                    if (aTrail != null)
                    {
                        return aTrail;
                    }
        ...
        public static bool IsFullOfAttachments(EffectSystem effectSystem, AttachmentID theAttachmentID)
        {
            ...
            Attachment aAttachment = effectSystem.mAttachmentHolder.mAttachments.DataArrayTryToGet(theAttachmentID);
            return aAttachment != null && aAttachment.mNumEffects >= EffectConstants.MAX_EFFECTS_PER_ATTACHMENT;
        }
        ...
        public static ref AttachEffect CreateEffectAttachment(EffectSystem effectSystem, ref AttachmentID theAttachmentID, EffectType theEffectType, uint theDataID, float theOffsetX, float theOffsetY)
        {
            ...
            Debug.Assert(aAttachment.mNumEffects < EffectConstants.MAX_EFFECTS_PER_ATTACHMENT);
        ...
        private static void ValidateParticleSystem(EffectSystem effectSystem, ParticleSystem particleSystem)
        {
        ...
        private static void ValidateTrailSystem(EffectSystem effectSystem, EffectViewer.EffectRuntime.Trail.Trail trail)
        {
            if (trail == null)
            {
