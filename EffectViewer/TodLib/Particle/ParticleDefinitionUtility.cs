...
namespace EffectViewer.TodLib.Particle
{
    ...
    {
        public static TodParticleDefinition CreateEmpty()
        {
        ...
        public static TodParticleDefinition Clone(TodParticleDefinition source)
        {
            if (source is null)
            {
                return CreateEmpty();
            ...
            TodParticleDefinition clone = new()
            {
                mEmitterDefs = new TodEmitterDefinition[count],
        ...
        public static void ApplyRuntimeDefaults(TodParticleDefinition definition)
        {
        ...
        private static TodEmitterDefinition CloneEmitter(TodEmitterDefinition source)
        {
            if (source is null)
            {
            ...
            TodEmitterDefinition clone = new()
            {
        ...
        private static void ApplyRuntimeDefaults(TodEmitterDefinition emitter)
        {
            if (emitter is null)
            {
                return;
