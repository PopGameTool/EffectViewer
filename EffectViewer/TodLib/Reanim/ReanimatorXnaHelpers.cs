...
namespace EffectViewer.TodLib.Reanim
{
    internal class ReanimatorXnaHelpers
    {
        ...
        public static void BlendTransform(ref ReanimatorTransform theResult, in ReanimatorTransform theTransform1, in ReanimatorTransform theTransform2, float theBlendFactor)
        {
            ...
            theResult.mSkewX = TodCommon.FloatLerp(theTransform1.mSkewX, aSkewX2, theBlendFactor);
            theResult.mSkewY = TodCommon.FloatLerp(theTransform1.mSkewY, aSkewY2, theBlendFactor);
